...
additive_mod_back_aic = step(additive_model, direction = "backward")
additive_mod_back_bic = step(additive_model, direction = "backward", k = log(n))
...
corr_mod_1_back_aic = step(corr_removed_model_1, direction = "backward")
corr_mod_2_back_aic = step(corr_removed_model_2, direction = "backward")
corr_mod_3_back_aic = step(corr_removed_model_3, direction = "backward")

corr_mod_1_back_bic = step(corr_removed_model_1, direction = "backward", k = log(n))
corr_mod_2_back_bic = step(corr_removed_model_2, direction = "backward", k = log(n))
corr_mod_3_back_bic = step(corr_removed_model_3, direction = "backward", k = log(n))
...
tranform_mod_1_back_aic = step(log_transform_1, direction = "backward")
tranform_mod_2_back_aic = step(log_transform_2, direction = "backward")
tranform_mod_3_back_aic = step(log_transform_3, direction = "backward")

tranform_mod_1_back_bic = step(log_transform_1, direction = "backward", k = log(n))
tranform_mod_2_back_bic = step(log_transform_2, direction = "backward", k = log(n))
tranform_mod_3_back_bic = step(log_transform_3, direction = "backward", k = log(n))
...
corr_model_summary = data.frame(
  Variables_Log_Transformed = c("corr AIC model 1", "corr AIC model 2", "corr AIC model 3", 
...
knitr::kable(corr_model_summary, caption = "correlation transformed model AIC and BIC Summary", digits = 4)
